...
;(function ($, undefined) {
  ...
  defaults = {
    ...
    unmaskInput: true, // only digits in input field or not 
    removeFixInput: true, // allow separators but nof prefix or suffix in input field
    minDigits: 4, // 1000 to ..
  ...
  $.fn[pluginName] = function (mixed) {
    return this.each(function() {
      ...
      if (typeof mixed === 'object' && !instance) {
